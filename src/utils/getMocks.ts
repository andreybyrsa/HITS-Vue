...
export const tasksMocks: Task[] = [
  ...
  },
  {
    ...
    position: 1,
    name: 'Нужно сделать',
    description: 'Ну очень важная сделать',
    initiator: usersMocks[1],
    executor: null,
    workHour: '8ч',
    startDate: '08.01.22',
  ...
  },
  {
    ...
    projectId: '0',
    position: 2,
    name: 'Постараться сделать задачу',
    description: 'Сильно постараться',
    initiator: usersMocks[2],
    executor: null,
    workHour: '4ч',
    startDate: '06.11.20',
  ...
  },
  {
    ...
    projectId: '0',
    position: 3,
    name: 'Совершенно необходимо сделать',
    description: 'Ну очень нужно',
    initiator: usersMocks[0],
    executor: null,
    workHour: '2ч',
    startDate: '06.01.21',
    tag: [tagsMocks[3], tagsMocks[0], tagsMocks[1], tagsMocks[2]],
    taskMovementLog: ['InBackLog', 'NewTask'],
    status: 'InBackLog',
  },
]
