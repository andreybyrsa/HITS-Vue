...
export const indicatorsMocks: Indicator[] = [
  ...
  {
    idIndicator: '3',
    value: 'Каков ваш взгляд на коммуникацию в команде?',
    type: 'MEMBER',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '4',
    value: 'Как оцениваете общение в команде?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '5',
    value: 'Какие ваши мысли о навыках команды?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'hard',
  ...
  {
    idIndicator: '6',
    value: 'Что вы думаете о взаимодействии с коллегами?',
    type: 'MEMBER',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '7',
    value: 'Как оценить атмосферу в коллективе?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '8',
    value: 'Ваше мнение о компетентности команды?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'hard',
  ...
  {
    idIndicator: '9',
    value: 'Что вы думаете о взаимодействии внутри группы?',
    type: 'MEMBER',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '10',
    value: 'Как воспринимаете атмосферу в команде?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '11',
    value: 'Как вы оцениваете профессионализм коллег?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'hard',
  ...
  {
    idIndicator: '12',
    value: 'Ваш взгляд на взаимодействие с коллегами?',
    type: 'MEMBER',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '13',
    value: 'Что вы думаете о внутренних отношениях в команде?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '14',
    value: 'Как вы оцениваете профессиональные навыки команды?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'hard',
  ...
  {
    idIndicator: '15',
    value: 'Ваше мнение о взаимодействии с коллегами?',
    type: 'MEMBER',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '16',
    value: 'Что вы думаете о взаимодействии в команде?',
    type: 'MEMBER',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '17',
    value: 'Как вы оцениваете атмосферу в команде?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
  ...
  {
    idIndicator: '18',
    value: 'Что вы думаете о профессионализме команды?',
    type: 'TEAM',
    role: 'MEMBER',
    visible: true,
    category: 'hard',
  ...
  {
    idIndicator: '19',
    value: 'Ваш взгляд на взаимодействие с коллегой?',
    type: 'MEMBER',
    role: 'MEMBER',
    visible: true,
    category: 'soft',
