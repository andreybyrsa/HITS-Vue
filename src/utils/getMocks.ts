...
export const tasksMocks: Task[] = [
  {
    ...
    sprintId: '3',
    projectId: '0',
    name: 'Сделать приглашения команд в идею инициатором',
  ...
  },
  {
    ...
    sprintId: '3',
    projectId: '0',
    name: 'Переделать сервисы авторизации',
  ...
  },
  {
    ...
    sprintId: '3',
    projectId: '0',
    name: 'Переделать модальное окно идеи на бирже',
    description: 'Создать отдельный сервис для авторизации пользователей',
    initiator: usersMocks[0],
    executor: null,
    workHour: '3ч',
  ...
  },
  {
    id: '7512572',
    projectId: '0',
    name: 'Сделать перевод идей',
    description: 'Создать отдельный сервис для авторизации пользователей',
    initiator: usersMocks[0],
    workHour: '3ч',
    startDate: '01.01.24',
    tag: [tagsMocks[1]],
    taskMovementLog: ['InBackLog', 'Done'],
    status: 'Done',
  },
  {
    id: '7213612',
    projectId: '0',
    name: 'Сделать перевод списка',
    description: 'Создать отдельный сервис для авторизации пользователей',
    initiator: usersMocks[0],
    workHour: '3ч',
    startDate: '01.01.24',
  ...
  },
  {
    id: '7213612',
    projectId: '0',
    name: 'Сделать модальное окно завершения проекта',
    description: 'Создать отдельный сервис для авторизации пользователей',
    initiator: usersMocks[0],
    workHour: '3ч',
    startDate: '01.01.24',
  ...
  },
  {
    id: '7213612',
    projectId: '0',
    name: 'Сделать модальное окно для бэклога',
    description: 'Создать отдельный сервис для авторизации пользователей',
    initiator: usersMocks[0],
    workHour: '3ч',
    startDate: '01.01.24',
  ...
  },
  {
    id: '7213612',
    projectId: '0',
    name: 'Сделать кнопку "Зарегестрироваться"',
    description: 'Создать отдельный сервис для авторизации пользователей',
    initiator: usersMocks[0],
    workHour: '3ч',
    startDate: '01.01.24',
...
export const averageMarkMocks: AverageMark[] = [
  {
    ...
    projectRole: 'TEAM_LEADER',
    mark: '9.9',
    tasks: [tasksMocks[3], tasksMocks[4], tasksMocks[6], tasksMocks[7]],
  },
  {
    id: '1010',
    projectId: '0',
  ...
  },
  {
    ...
    projectRole: 'MEMBER',
    mark: '8.3',
    tasks: [tasksMocks[4], tasksMocks[7]],
  },
]
