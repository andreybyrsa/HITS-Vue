const hints = {
  ...
  problem:
    ...
    '<br/>Пример 1: (хороший): Пользователи соцсетей нуждаются в интересном или полезном контенте, которые могут предоставить HTML5 приложения<br/>' +
  ...
  description:
    ...
    '<br/>Например: Наличие MacBook, наличие специальных аккаунтов (gmail, github и т.п.)',
  customer:
